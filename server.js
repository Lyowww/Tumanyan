...
const POEMS = [
  {
    title: "ՄԵՐ ՈՒԽՏԸ",
    text: `Մենք ուխտ ունենք՝ միշտ դեպի լույս, <br> 
...
Դեպի լույսը մեր ուխտի։`
  },
  {
    ...
    text: `Մեր ճամփեն խավար, մեր ճամփեն գիշեր,<br>  
...
Արնոտ լեռներում։`
  ...
  {
    title: "ՀՐԱԺԵՇՏ",
    text: `Այստեղ ահա կըբաժանվենք.  <br>
...
Շուրջդ պիտի թրթռա։`
  ...
  {
    title: "ԻՄ ՍԵՐԸ",
    text: `Ես սիրել եմ վարդը տժգույն  <br>
...
Հայտնելու չեմ աշխարհին։`
  },
  {
    ...
    text: `Մի՞տդ է գալիս մեր քեֆն, ընկեր,<br>
